...
<body>
    ...
    <div class="page-container">
        <!--================================-->
        <?
                $this->load->view('layouts/adm/sidebar', ['pn'=>'additions','this_user'=>$this_user]);
            ?>
        <!--================================-->
        <!-- Page Content Start -->
        <!--================================-->
                            ...
                            <div class="card mg-b-40">
                                <div class="card-header">
                                    <div class="d-flex justify-content-between align-items-center">
                                        <h6 class="card-header-title tx-13 mb-0 text-uppercase">Users </h6>
                                ...
                                <div class="card-body pd-0">
                                    <table id="basicDataTable" class="table hover responsive display nowrap">
                                        ...
                                        <tbody>
                                            <?foreach($additions as $k => $add){?>
                                            <tr>
                                            
                                            <td><small><?=$add['date']?></small></td>
                                            <td><?=$add['type']?></td>
                                            <td><?=$add['cur']?></td>
                                            <td><?=$add['sum']?></td>
                                            <td><?=$add['usr_ob']['login']?></td>
                                            <td><small><?=$add['detail']?></small></td>
                                            <td><small><?=$add['adr']?></small></td>

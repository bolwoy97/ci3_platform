...
<body>
    ...
    <div class="page-container">
        <!--================================-->
        <?
                $this->load->view('layouts/adm/sidebar', ['pn'=>'withdrawals','this_user'=>$this_user]);
            ?>
        <!--================================-->
        <!-- Page Content Start -->
        <!--================================-->
                                    ...
                                    <table id="basicDataTable" class="table hover responsive display nowrap">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td><?=$with['date']?></td>
                                                <td><a target="_blank"
                                                        href="admin/AdminController/user/<?=$with['usr_ob']['id']?>"><?=$with['usr_ob']['login']?></a></td>
                                                <td><?=$with['cur']?></td>
                                                <td>$<?=$with['sum']?></td>
                                                <?if(isset($with['usr_ob']['adr_with_'.$with['cur']])){?>
                                                    <td><?=$with['usr_ob']['adr_with_'.$with['cur']]?></td>
                                                <?}else{?>
                                                    <td><?=$with['cur']?></td>
                                                <?}?>
                                                <td>
                                                    <a onclick="confirmWith(<?=$with['id']?>,<?=$with['sum']?>,'<?=$with['usr_ob']['login']?>')"
                                                        href="#confirmOrder" data-toggle="modal"
                                                        class="fa fa-check-circle tx-success mg-r-10">confirn</a>
                                                    <a onclick="cancelWith(<?=$with['id']?>,<?=$with['sum']?>,'<?=$with['usr_ob']['login']?>')"

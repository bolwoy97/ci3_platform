    ...
    <div class="col-md-12 col-lg-6">
        <div class="card">
            <div class="card-body">
               ...
               <h2 class="form_variant_title"><?=lang('txt154')?></h2>
            ...
            ?>
                        ...
                        <div class="paysumm_curs_note"><?=lang('txt156')?>
                        </div>
                        <div class="pay_form_summ_field">
                            ...
                            ?>
                            2. <?=lang('txt137')?> (<span class="pay_valute"><?php echo strtoupper($pay_valute);?></span>)

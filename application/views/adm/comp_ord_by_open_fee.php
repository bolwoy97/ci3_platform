...
<body>
    ...
    <div class="page-container">
        <!--================================-->
        <?
                $this->load->view('layouts/adm/sidebar', ['pn'=>'comp_ord_by_open_fee','this_user'=>$this_user]);
            ?>
        <!--================================-->
        <!-- Page Content Start -->
        <!--================================-->
                        ...
                        <div class="card mg-b-40">
                            <div class="card-header">
                                <div class="d-flex justify-content-between align-items-center">
                                    <h6 class="card-header-title tx-13 mb-0 text-uppercase">lost_fees</h6>
                            ...
                            <div class="card-body pd-0">
                                <table id="basicDataTable" class="table hover responsive display nowrap">
                                    ...
                                    <tbody>
                                        <?foreach($lost_fees as $k => $lost_fee){?>
                                        <tr>
                                            <td><?=$lost_fee['date']?></td>
                                            <td><?=$lost_fee['usr_ob']['login']?></td>
                                            <td><?=round($lost_fee['sum'],2)?></td>
                                        </tr>
                                        <?}?>

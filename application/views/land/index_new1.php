...
<head>
    ...
    <!-- fonts -->
    <link href="assets/land/fontssfuidisplay.css" rel="stylesheet">
    <!-- Icon fonts -->
                    ...
                    <div class="col-12 col-lg-7 remove-space--bottom">
                        ...
                        <div class="d-md-flex mb-4 mb-lg-5 text-center text-md-left reveal">
                            ...
                            <div>
                                ...
                                <p class="text-color--500">Уникальный алгоритм (Profit-oriented Algorithm) способствует росту цены токенов. Это отличная возможность ивестировать свои средства в токен YRD как крупным, так и мелким инвесторам. </p>
                            </div>
                        </div>
                        <div class="d-md-flex mb-4 mb-lg-5 text-center text-md-left reveal">
                            <span class="mb-3 mb-lg-0 mr-md-5">
                            ...
                            <div>
                                <h3 class="h6-font font-w--600 text-color--200 mb-1">Сетевикам</h3>
                                <p class="text-color--500">Учитывая необходимость создавать реальный спрос, мы вознаграждаем участников за оборот их рефералов до 10 уровней. Именно инвесторы и их капиталы, способствуют росту цены. Поэтому мы вознаграждаем участников, за привлечение инвесторов и капиталов.</p>
                            </div>
                        </div>
                        <div class="d-md-flex mb-4 mb-lg-5 text-center text-md-left reveal">
                            <span class="mb-3 mb-lg-0 mr-md-5">
                            ...
                            <div>
                                ...
                                <p class="text-color--500">Большинство компаний испытывают трудности с выводом токена на биржу и последующим ростом его цены. На это влиюет отсутствие интереса у трейдеров, а так же сложности связаные с управлением капиталами маркетмейкерами. Этих трудностей у компаний на Yard не будет.</p>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row horizontal-border justify-content-between mb-lg-5 pb-lg-5 reveal">
                        ...
                        <div class="col-12 col-md-6 col-lg-5">
                            <div class="d-lg-flex mb-4 mb-lg-0 text-center text-md-left">
                                ...
                                <div>
                                    <h3 class="h5-font text-color--200 font-w--600 mb-2">Стандартный P2P алгоритм</h3>
                                    <p class="text-color--500">Привычный всем трейдерам алгоритм. Обеспечивает формирование привычных биржевых стаканов из ордеров на покупку и продажу.</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="row horizontal-border justify-content-between mb-lg-5 pb-lg-5 reveal">
                        ...
                        <div class="col-12 col-md-6 col-lg-5">
                            <div class="d-lg-flex mb-4 mb-lg-0 text-center text-md-left">
                                ...
                                <div>
                                    <h3 class="h5-font text-color--200 font-w--600 mb-2">Реферальные бонусы</h3>
                                    <p class="text-color--500">Успех любого рынка зависит от сообщества, которое в нем участвует. Наши программы вознаграждения за привлечение участников и капиталов, увеличивает сообщество.</p>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="switchable pt-4 d-lg-flex align-items-md-center" id="cabinet">
                <div class="col-12 col-lg-6 mb-40 mb-lg-0 text-center mb-3 reveal">
                    <picture class="switchable__image">
                        <img src="assets/land/img/acc.png" alt="image" class="assets/land/img-fluid">
                    </picture>
                </div>
